program atmosphere_test_imperial 
    ...
    real :: temp_R, pressure_lbf_per_ft2, density_slugs_per_ft3,dyn_viscosity_slug_per_ft_sec, sos_ft_per_sec
    real :: res(7)
    integer :: i, io_unit
    ...
    ! BUILD THE HEADER
    write(io_unit,'(8X,A22,4X,A25,1X,A14,12X,A18,1X,A26,7X,A20,A25)') &
        "Geometric_Altitude[ft]", "Geopotential_Altitude[ft]", "Temperature[R]", &
        "Pressure[lbf/ft^2]", "Density[slugs/ft^3]","Speed_of_Sound[ft/s]", "Dynamic Viscosity"
    ...
    do i = 0, 200000, 10000
        ...
        pressure_lbf_per_ft2, density_slugs_per_ft3, sos_ft_per_sec, dyn_viscosity_slug_per_ft_sec/)
